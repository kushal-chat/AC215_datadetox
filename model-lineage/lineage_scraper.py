...
def build_graph(data_store: DVCDataStore) -> tuple:
    ...
    logger.info(f"✓ Built graph with {len(graph_data.models)} models, "
...
Examples:
  ...
  python lineage_scraper.py --load-neo4j --clear
    ...
    parser.add_argument("--load-neo4j", action="store_true",
                       help="Load graph to Neo4j")
    parser.add_argument("--clear", action="store_true",
                       help="Clear existing Neo4j data before loading")
    parser.add_argument("--commit", action="store_true",
                       help="Commit to DVC and Git")
    ...
    parser.add_argument("--message", type=str, default=None,
                       help="Commit message for version control")
